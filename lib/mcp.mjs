...
import { BRIDGE_ROOT, clip, dshHome, readText, writeText } from './util.mjs';
	...
	return [
		{
			...
			inputSchema: {
				...
				properties: {
					...
					provider: {
						type: 'string',
						description: '本次运行使用的模型服务商 id —— 取值必须是你本机 DSH 里**已注册**的 provider(可用 dsh_health 的 models.providers 查;本机当前是 "rigol")。一般省略,交给 DSH 默认配置。写错的 id **不会回退**:DSH 直接失败(NO_ADAPTER)。',
					},
					reasoning_effort: {
						type: 'string',
